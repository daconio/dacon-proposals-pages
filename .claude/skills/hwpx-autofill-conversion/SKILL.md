...
### 주제를 슬롯에 매핑하는 것은 스크립트가 아니라 Claude가 한다
...
autofill 이 `[autofill] mode=... wrote out.hwpx` 를 찍었다고 해서 끝이 아닙니다. 다음을 Claude 가 직접 확인하세요:
