...
1. **Claude in Chrome** (`mcp__claude-in-chrome__*`): `tabs_context_mcp`로 연결 확인
...
- Lightbox 클릭 확대 포함
- 참고: .claude/skills/manual-maker/references/html-template.md
