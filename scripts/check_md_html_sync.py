...
# 사전 정의된 검사 페어 (확장 가능)
# 규칙: .md 와 .html 이 동일한 base name을 공유해야 함.
# 일부 pair는 md/html 모두 _슬라이드 suffix를 갖는 경우도 허용.
PAIRS = {
    "강원대": (
    ...
    "미래에셋_금융리서치": (
        "제안/2026-03-27-미래에셋증권_금융리서치AI교육_제안서.md",
        "제안/2026-03-27-미래에셋증권_금융리서치AI교육_제안서.html",
    ),
    "미래에셋_DAKER연동": (
        "제안/2026-03-30-미래에셋증권_DAKER교육연동_요약서.md",
        "제안/2026-03-30-미래에셋증권_DAKER교육연동_요약서.html",
    ),
    "JB금융그룹": (
        "제안/2025-12-10-JB금융그룹_AI경진대회_제안서.md",
        "제안/2025-12-10-JB금융그룹_AI경진대회_제안서.html",
    ),
    "삼척시_메이커캠프": (
        "제안/2026-01-16-삼척시_교육특구_AI헬스케어에너지_메이커캠프_제안서.md",
        "제안/2026-01-16-삼척시_교육특구_AI헬스케어에너지_메이커캠프_제안서.html",
    ),
    "차세대융합기술원": (
        "제안/2026-01-27-차세대융합기술원_제조산업_바이브코딩_경진대회_제안서.md",
        "제안/2026-01-27-차세대융합기술원_제조산업_바이브코딩_경진대회_제안서.html",
    ),
    "온오프라인_하이브리드": (
        "제안/2026-03-22-온오프라인_하이브리드_교육연계_해커톤_제안서.md",
        "제안/2026-03-22-온오프라인_하이브리드_교육연계_해커톤_제안서.html",
    ),
    "단국대_AI대회": (
        "제안/2026-03-23-단국대학교_AI대회_제안서.md",
        "제안/2026-03-23-단국대학교_AI대회_제안서.html",
    ),
    "데이콘_서비스_소개서": (
        "내부/2026-03-27-데이콘_서비스_소개서.md",
        "내부/2026-03-27-데이콘_서비스_소개서.html",
    ),
    "데이콘_서비스_제안서": (
        "제안/2026-03-27-데이콘_서비스_제안서.md",
        "제안/2026-03-27-데이콘_서비스_제안서.html",
    ),
    "GS_E&R": (
        "제안/2026-03-27-GS_E&R_AI경진대회_제안서.md",
        "제안/2026-03-27-GS_E&R_AI경진대회_제안서.html",
    ),
    "단국대_SW중심": (
        "제안/2026-03-29-단국대학교_SW중심대학_사전대회_제안서.md",
        "제안/2026-03-29-단국대학교_SW중심대학_사전대회_제안서.html",
    ),
    "데이커_바이브코딩_해커톤": (
        "제안/2026-03-29-데이커_바이브코딩_해커톤_제안서.md",
        "제안/2026-03-29-데이커_바이브코딩_해커톤_제안서.html",
    ),
    "데이콘_알고리즘": (
        "제안/2026-03-29-데이콘_알고리즘_경진대회_제안서.md",
        "제안/2026-03-29-데이콘_알고리즘_경진대회_제안서.html",
    ),
    "데이콘_프롬프톤": (
        "제안/2026-03-29-데이콘_프롬프톤_범용_제안서.md",
        "제안/2026-03-29-데이콘_프롬프톤_범용_제안서.html",
    ),
    "데이스쿨_AI교육": (
        "제안/2026-03-30-데이스쿨_AI교육_종합_제안서.md",
        "제안/2026-03-30-데이스쿨_AI교육_종합_제안서.html",
    ),
    "삼성디스플레이": (
        "제안/2026-03-30-삼성디스플레이_AI서비스개발_경진대회_제안서.md",
        "제안/2026-03-30-삼성디스플레이_AI서비스개발_경진대회_제안서.html",
    ),
    "DAKER_dacon_통합계획": (
        "제안/2026-04-01-DAKER_dacon통합계획.md",
        "제안/2026-04-01-DAKER_dacon통합계획.html",
    ),
    "한국수자원공사": (
        "제안/2026-04-06-한국수자원공사_사내경진대회_및_교육_제안서.md",
        "제안/2026-04-06-한국수자원공사_사내경진대회_및_교육_제안서.html",
    ),
    "DAKER_플랫폼_매뉴얼": (
        "제안/2026-03-30-DAKER_플랫폼_매뉴얼.md",
        "제안/2026-03-30-DAKER_플랫폼_매뉴얼.html",
    ),
    "통합_마스터_템플릿": (
        "제안/0000-00-00-제안서_통합_마스터_템플릿.md",
        "제안/0000-00-00-제안서_통합_마스터_템플릿.html",
    ),
    # 아래는 MD와 HTML 모두 _슬라이드 suffix를 가진 aligned pair
    "DAKER_관리자_매뉴얼": (
        "내부/2026-03-22-DAKER_관리자_매뉴얼_슬라이드.md",
        "내부/2026-03-22-DAKER_관리자_매뉴얼_슬라이드.html",
    ),
    "Anthropic_하네스": (
        "내부/2026-03-28-Anthropic_하네스설계_장시간앱개발_슬라이드.md",
        "내부/2026-03-28-Anthropic_하네스설계_장시간앱개발_슬라이드.html",
    ),
    "DAKER_FDE_기획": (
        "전략/2026-03-23-DAKER_FDE_기획_슬라이드.md",
        "전략/2026-03-23-DAKER_FDE_기획_슬라이드.html",
    ),
    "DAKER_바이브코딩_미래방향성": (
        "전략/2026-03-23-DAKER_바이브코딩_미래방향성_슬라이드.md",
        "전략/2026-03-23-DAKER_바이브코딩_미래방향성_슬라이드.html",
    ),
    "데이콘_바이브코딩_조직도": (
        "전략/2026-03-25-데이콘_바이브코딩_15인_글로벌조직도.md",
        "전략/2026-03-25-데이콘_바이브코딩_15인_글로벌조직도.html",
    ),
}

# 양쪽에 모두 등장해야 하는 핵심 키워드 (페어별로 다를 수 있음)
# 강원대만 세밀하게 등록, 나머지는 기본 구조만 검증
KEY_FACTS = {
    "강원대": [
        "250명", "65팀", "11팀",
        "5.18", "6.29", "7.6", "7.8",
